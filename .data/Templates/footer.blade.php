<footer class="text-mint font-seria font-medium leading-[1.3] pt-15 lg:pt-30">
  ...
  <div class="grid grid-cols-12 gap-16 items-end text-base">
    <div class="col-span-2 md:col-span-1 mb-2">
      <a 
        ...
        {{ partial:icons/logo-marketer class="block w-auto h-100 md:h-120" }}
      </a>
    </div>
    <div class="col-span-10 md:col-span-5 lg:col-span-6 sm:grid sm:grid-cols-6 gap-16">
      ...
      <div class="sm:col-span-3 md:col-span-6 lg:col-span-3">
        <a 
          href="tel:043 537 33 53"
          class="no-underline hover:underline underline-offset-4 decoration-1">
          Telefon 043 537 33 53
        </a><br>
        <a 
          href="mailto:zoe@cavegn-immobilien.ch" 
          title="E-Mail an zoe@cavegn-immobilien.ch"
          class="no-underline hover:underline underline-offset-4 decoration-1">
          zoe@cavegn-immobilien.ch
        </a><br>
        <a href="https://www.cavegn-immobilien.ch" 
          target="_blank" 
          title="Zur Website von Cavegn Immobilien" 
    ...
    <div class="col-span-3 col-start-3 sm:col-span-5 sm:col-start-3 md:col-span-3 lg:col-span-2 lg:mb-15">
      Follow us!<br>
      <a href="https://www.instagram.com/cavegn_immobilien_zh/" 
        target="_blank" 
        title="Follow us on Instagram!" 
        rel="noopener noreferrer"
        class="block group mt-2">
        {{ partial:icons/instagram class="md:w-24 h-auto group-hover:rotate-6 transition-transform" }}
      </a>
    </div>
    <div class="col-span-3 sm:col-span-5 md:col-span-3 md:col-start-10 lg:col-start-11 lg:mb-20">
      <a href="/impressum" class="no-underline hover:underline underline-offset-4 decoration-1">Impressum</a><br>
      <a href="/datenschutz" class="no-underline hover:underline underline-offset-4 decoration-1">Datenschutz</a><br>
    </div>
  </div>
  {{ /partial:layout/inner }}
</footer>